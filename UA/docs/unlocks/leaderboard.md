...
Пам'ятайте, що ви можете використовувати `num_unlocked(unlock) > 0`, щоб перевірити, чи щось розблоковано, і ви можете використовувати `get_cost()` на розблокування, щоб побачити їхню вартість і автоматично фармити потрібні предмети.
