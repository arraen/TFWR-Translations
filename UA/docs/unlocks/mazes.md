# Mazes (Лабіринти)
`Items.Weird_Substance`, який отримується при [удобренні](docs/unlocks/fertilizer.md) рослин, має дивний вплив на кущі (bushes). Якщо дрон знаходиться над кущем, і ви викликаєте `use_item(Items.Weird_Substance, amount)`, кущ перетвориться на лабіринт із живоплоту (hedges).
...
Десь у живоплоті захований скарб (treasure). Використовуйте `harvest()` на скарбі, щоб отримати золото (gold), що дорівнює площі лабіринту. (Наприклад, лабіринт 5x5 дасть 25 золота.)
...
Лабіринти не містять жодних петель (loops), якщо ви не використовуєте лабіринт повторно (див. нижче, як повторно використовувати лабіринт). Тому дрон не може опинитися в тій самій позиції знову, не повертаючись назад.
...
Це збере скарб і створить (spawn) новий скарб у випадковому місці лабіринту.
...
Скарб можна переміщувати до 300 разів. Після цього використання weird substance на скарбі більше не збільшуватиме золото в ньому, і він більше не рухатиметься.
